                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    <div className="flex items-center gap-3">
                        <Link href="/" className="flex items-center gap-2">
                            <span className="text-base text-gray-900"> © bPresent {new Date().getFullYear()}</span>
                        </Link>
                    </div>
                    ...
                    <div className="flex gap-3">
                        ...
                        <a href="https://www.facebook.com/almahmud1234" className="text-gray-400 hover:text-indigo-600 transition-colors" aria-label="Facebook">
